...
describe("Dataset upload test --> ", function () {
		...
		beforeEach(function () {		
			dataUploadView = Ext.create('MES.view.datasetintegration.DataUploadView', {});		
...
describe("Upload dataset from file system functionality--", function() {
    ...
    beforeEach(function() {
        uploadView = Ext.create('MES.view.datasetintegration.DataUploadView',{});
        uploadController = uploadView.getController();
        
        
        mainView = Ext.create('MES.view.main.Main');
    ...
    describe("Check the upload functionality", function() {
        ...
        beforeEach(function() {
            ...
            controller = Ext.create('MES.view.datasets.DatasetPanelController');
            var date = new Date();
