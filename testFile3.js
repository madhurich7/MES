...
describe("Create test cases for MES", function() {
   ...
   beforeEach (function () {
    ...
    dataSetMetaDataPanel=		Ext.create('MES.view.datasets.metadata.DataSetMetaDataPanel',{});
  datagrid = Ext.create('Ext.grid.Panel',{});
  controller = Ext.create('MES.view.datasets.metadata.DataSetMetaDataController');
